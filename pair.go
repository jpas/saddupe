...
import (
	...
	"github.com/jpas/saddupe/internal/btmgmt"
	"github.com/jpas/saddupe/internal/l2"
	"github.com/jpas/saddupe/internal/profile"
)
...
func NewSpoofer(host string) (*Spoofer, error) {
	...
	p, err := profile.Register(profilePath, profileUUID, options)
	if err != nil {
		return nil, err
	}
